          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: TextButton(
                        ...
                        style: TextButton.styleFrom(
                          backgroundColor:
                          isRoundTrip ? Colors.white : Colors.indigo[700],
                        ),
                        child: Text(
                          'یک طرفه',
                          style: TextStyle(
                    ...
                    Expanded(
                      child: TextButton(
                        ...
                        style: TextButton.styleFrom(
                          backgroundColor:
                          isRoundTrip ? Colors.indigo[700] : Colors.white,
                        ),
                        child: Text(
                          'دو طرفه',
                          style: TextStyle(
                ...
                if (isRoundTrip) SizedBox(height: 16.0),
                if (isRoundTrip)
                  DateTimePicker(
                          ...
                          builder: (context) {
                            return FlightSearchResultsPageRaft(
                              username: widget.username,
                                ...
                                dataTimetwo: returnDate,
                                Roundtrip: isRoundTrip,
                                pass: totalPassengers,
                            international: true,);
                          },
                        ));
                      } else {
                              ...
                              content: Container(
                                ...
                                child: StatefulBuilder(
                                  builder: (context, setState) {
                                    return Center(
                                      child: Text("لطفا تمام فیلد ها را پر کنید"),
                                    );
                                  },
                                ),
                              ),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        color: isEnabled
            ? Colors.grey[200]
            : Colors.grey[300], // Change color based on isEnabled
        padding: EdgeInsets.all(16.0),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
